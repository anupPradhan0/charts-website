...
export const en = {
  ...
  about: {
    ...
    whereDataBody: [
      "Every market and every value on this site is a row in a PostgreSQL database. The archive was produced once by a seeded generator keyed on the market and the date, so it is reproducible; everything published after that is entered through the administration panel.",
      "The database sits behind a service layer, and the pages and the public API both read through that layer. Nothing keeps its own copy of the data, so a change made by an administrator appears on the very next request.",
    ],
    seeAlso:
  ...
  faqs: {
    ...
    a2: "No. Every market name, schedule and value is invented for this demonstration. The archive was seeded by a pseudo-random function keyed on the market and the date, and now lives in a PostgreSQL database that administrators maintain.",
  ...
  admin: {
    ...
    dashboard: {
      title: "Dashboard",
      description: "Everything the site is publishing, counted straight from the database.",
      totalCategories: "Total categories",
      activeCategories: "Active categories",
      totalResults: "Total results",
      publishedToday: "Results published today",
      ofTotal: "of {count} total",
      pausedCount: "{count} paused",
      pendingToday: "{count} still pending today",
      archiveSize: "across the whole archive",
      statusBreakdown: "Published {published} · Pending {pending} · Scheduled {scheduled}",
      activity: "Publication activity",
      activityHint: "Entries published per day over the last 14 days.",
      recentResults: "Recent results",
      recentResultsHint: "The newest entries by result date.",
      recentCategories: "Recently created categories",
      recentCategoriesHint: "The most recently added markets.",
      latestUpdates: "Latest updates",
      latestUpdatesHint: "The entries changed most recently.",
      lastUpdated: "Last change",
      noResultsYet: "No results yet",
      noResultsYetHint: "Create a category, then add its first result.",
    ...
    categories: {
      title: "Categories",
      description: "Every market the site publishes, and the results attached to each.",
      create: "Create category",
      createTitle: "Create category",
      createDescription: "Add a market. It appears on the public site as soon as it is saved.",
      editTitle: "Edit category",
      editDescription: "Changes reach the public site on the next request.",
      ...
      emptyHint: "Create your first category to begin managing results.",
      noMatchTitle: "No category matches these filters",
      ...
      deleteBody: "This action cannot be easily undone.",
      deleteBlockedTitle: "This category cannot be deleted",
      deleteBlockedBody:
        "{count} results still belong to {name}. Deleting it would take the archive with it. Deactivate the category instead — its history stays readable and no new entries are published.",
      ...
      groupFilter: "Group",
      inThisCategory: "Results in this category",
      inThisCategoryHint: "The most recent entries. Open Results for the full archive.",
    },

    results: {
      title: "Results",
      description: "Every published value, its date, its time and its status.",
      create: "Create result",
      createTitle: "Create result",
      createDescription: "Add one entry for a market on a given day.",
      editTitle: "Edit result",
      editDescription: "Correct a value, move it to another day, or change its status.",
      detailTitle: "Result detail",
      bulk: "Bulk entry",
      searchLabel: "Search results",
      searchPlaceholder: "Market, value or date",
      colDate: "Date",
      ...
      emptyHint: "Create your first result, or widen the filters.",
      noMatchTitle: "No result matches these filters",
      noMatchHint: "Try a different date range, category or status.",
    ...
    bulk: {
      ...
      description:
        "Add several entries at once. Either every row is written or none is — the batch runs in a single database transaction.",
      addRow: "Add row",
      removeRow: "Remove row",
      rowLabel: "Row {index}",
      submit: "Submit {count} rows",
      submitOne: "Submit 1 row",
      submitting: "Submitting…",
      empty: "No rows yet. Add one to begin.",
      hint: "Leave the value blank for anything that is not published yet.",
    ...
    form: {
      ...
      nameOr: "Name (Odia)",
      slug: "Slug",
      slugHint: "Generated from the name. Edit it if you need a different URL.",
      descriptionEn: "Description (English)",
      descriptionHi: "Description (Hindi)",
      descriptionOr: "Description (Odia)",
      translations: "Translations",
      translationsHint:
        "Optional. A blank translation falls back to the English text rather than rendering empty.",
      scheduleTime: "Publication slot",
      scheduleTimeHint: "24-hour local time, e.g. 15:30.",
      group: "Market group",
      groupDay: "Day markets",
      groupNight: "Night markets",
      groupSpecial: "Special markets",
      isActive: "Active",
      isActiveHint: "Inactive markets stay readable on the site but publish nothing new.",
      displayOrder: "Display order",
      displayOrderHint: "Lower numbers come first.",
      updateFrequency: "Update frequency",
      accent: "Accent colour",
      accentOption: "Colour {number}",
      category: "Category",
      chooseCategory: "Choose a category",
      value: "Result value",
      valueHint: "Two digits, 00 to 99. Leave blank until the entry is published.",
      publishedDate: "Published date",
      publishedTime: "Published time",
      status: "Status",
      unsaved: "You have unsaved changes.",
      unsavedConfirm: "Leave this page? Your changes will be lost.",
    },

    notices: {
      created: "Saved. The change is live on the site.",
      updated: "Changes saved.",
      deleted: "Deleted.",
      activated: "Category activated.",
      deactivated: "Category deactivated. Its history stays readable on the site.",
      bulkCreated: "{count} results created.",
    ...
    login: {
      ...
      description: "This area manages the categories and results the public site publishes.",
      email: "Email",
      password: "Password",
      submit: "Sign in",
      signingIn: "Signing in…",
      hint: "Accounts are created by the database seed, never in source code.",
      backToSite: "Back to the site",
    },

    settings: {
      title: "Settings",
      description: "Who you are signed in as, and how this installation is wired up.",
      account: "Account",
      name: "Name",
      email: "Email",
      ...
      dataSourceHint:
        "PostgreSQL is the single source of truth. The public pages and this panel read the same rows through Prisma.",
      database: "Database",
      categoriesStored: "Categories stored",
      resultsStored: "Results stored",
      oldestEntry: "Oldest entry",
      newestEntry: "Newest entry",
      localisation: "Localisation",
      localisationHint:
        "Category names and descriptions are stored once per market in all three languages and resolved per reader.",
      sessionTitle: "Session",
      sessionHint: "Sessions last 12 hours. Signing out ends this one immediately.",
    },

    errors: {
      unauthorized: "Sign in to continue.",
      badCredentials: "That email and password do not match.",
      credentialsRequired: "Enter an email and a password.",
      invalidBody: "The request body could not be read.",
      checkFields: "Check the highlighted fields.",
      required: "This field is required.",
      tooLong: "This is too long.",
      nameRequired: "A name of at least two characters is required.",
      nameTaken: "Another category already uses this name.",
      descriptionRequired: "A description of at least ten characters is required.",
      ...
      timeFormat: "Use 24-hour HH:MM, e.g. 15:30.",
      dateFormat: "Use a YYYY-MM-DD date.",
      displayOrder: "Display order must be a whole number between 0 and 9999.",
      categoryRequired: "Choose a category.",
      categoryMissing: "That category no longer exists.",
      resultMissing: "That result no longer exists.",
      resultExists: "This category already has an entry for that date.",
      valueFormat: "Use exactly two digits, 00 to 99.",
      valueRequired: "A published entry needs a value.",
      valueNotPublished: "Only a published entry can carry a value.",
      deleteBlocked: "Results still belong to this category.",
      bulkDuplicate: "Two rows target the same category and date.",
    },
  },
} as const;
